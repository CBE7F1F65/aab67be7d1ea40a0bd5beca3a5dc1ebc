...
#define M_GAMESQUARE_RIGHT_0	(M_CLIENT_RIGHT-M_GAMESQUARE_EDGE)
...
#define	M_GAMESQUARE_LEFT_(X)	((M_GAMESQUARE_LEFT_0))
#define	M_GAMESQUARE_RIGHT_(X)	((M_GAMESQUARE_RIGHT_0))
...
#define	M_GAMESQUARE_CENTER_X_(X)	((M_GAMESQUARE_CENTER_X_0))
