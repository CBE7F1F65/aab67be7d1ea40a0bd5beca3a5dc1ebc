...
#define M_MAINVIEW_WIDTH	288.0f
#define M_MAINVIEW_HEIGHT	384.0f
#define M_MOVEABLE_WIDTH	304.0f

#define M_GAMESQUARE_EDGE		16.0f
#define M_GAMESQUARE_WIDTH		(M_CLIENT_WIDTH-M_GAMESQUARE_EDGE*2)
...
#define M_GAMESQUARE_LEFT		(M_CLIENT_LEFT+M_GAMESQUARE_EDGE)
#define M_GAMESQUARE_RIGHT		(M_CLIENT_RIGHT-M_GAMESQUARE_EDGE)
...
#define M_GAMESQUARE_BOSSX	M_GAMESQUARE_CENTER_X
