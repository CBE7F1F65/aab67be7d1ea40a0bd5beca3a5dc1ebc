...
rebuild:
		...
		hge->	Ini_SetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_1, RESCONFIGDEFAULT_LASTMATCHCHARA_1);
		hge->	Ini_SetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_2, RESCONFIGDEFAULT_LASTMATCHCHARA_2);
		hge->	Ini_SetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_3, RESCONFIGDEFAULT_LASTMATCHCHARA_3);
	...
	lastmatchchara[0]	= hge->Ini_GetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_1, RESCONFIGDEFAULT_LASTMATCHCHARA_1);
	lastmatchchara[1]	= hge->Ini_GetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_2, RESCONFIGDEFAULT_LASTMATCHCHARA_2);
	lastmatchchara[2]	= hge->Ini_GetInt(RESCONFIGS_CUSTOM, RESCONFIGN_LASTMATCHCHARA_3, RESCONFIGDEFAULT_LASTMATCHCHARA_3);
